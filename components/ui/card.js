...
function Card({ className, ...props }) {
    return (_jsx("div", { "data-slot": "card", className: cn("bg-card text-card-foreground flex flex-col gap-6 rounded-[var(--radius-card)] border py-6 shadow-none", className), ...props }));
}
