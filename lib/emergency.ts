...
export const EMERGENCY_BANNER =
  `EMERGENCY: ${INDIAN_EMERGENCY.national.number} (National) · ${INDIAN_EMERGENCY.police.number} (Police) · ${INDIAN_EMERGENCY.ambulance.number} (Ambulance) · ${INDIAN_EMERGENCY.coastGuard.number} (Coast Guard)`
